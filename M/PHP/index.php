	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
	    ...
	    <ul class="navbar-nav mr-right">
				...
				<div class="form-group">
					...
					<input type="text" name="login" class="form-control" id="exampleInputlogin" placeholder="Login" required/>
				</div>
				<div class="form-group">
				...
				<span style="color:blue">New here?</span> <a href="#"><b>Join Us</b></a>
				</div>
				 </div>
			</li>
		</ul>
...
<div class="row jumbotron">
	<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10 hero_heading text-center">
		<p class="lead" style="color:purple;">Powiedz, powiedz czemu Świat twój milczy cały blady od wzruszeń Niczym słońce zaćmione przez księżyc Czekające na chwile poruszeń. Powiedz, czemu pragniesz Dojrzeć w oknach świata część odległą Niczym drzewo więdnące bez skargi Czekające na deszcze z nadzieją.</p>
	</div>
...
<div class="row padding">
	<div class="col-lg-6">
		<h2>Nasze cele</h2>
		<p>Wykonaliśmy w terenie wielką pozytywistyczną pracę. Wierzę, że to przyniesie sukces. Prognozować jednak nie będę, bo wierzę w zasadę, że najlepszym sposobem przewidywania przyszłości jest jej tworzenie. </p>
